...
assert(taskProperties.includes('buildPipeMoodyLogMinorTicks'), 'Expected Moody chart to render log-scale minor grid ticks');
assert(taskProperties.includes('Log-Log Moody Chart'), 'Expected Moody chart title to communicate log-log scale');
assert(taskProperties.includes('Reynolds Number (log scale)'), 'Expected Moody chart X axis to label log scale');
assert(taskProperties.includes('Darcy f (log scale)'), 'Expected Moody chart Y axis to label log scale');
assert(taskProperties.includes('transform="rotate(-90'), 'Expected narrow Moody transition label to rotate vertically');
assert(!taskProperties.includes('pipe-moody-callout'), 'Moody chart should not render overlapping in-plot callout labels');
assert(taskProperties.includes('pipe-moody-chip-main'), 'Expected Moody chart marker details to use compact marker chips');
...
assert(styles.includes('pipe-moody-grid-minor'), 'Expected Moody chart minor log grid styling');
assert(styles.includes('pipe-moody-chart-meta'), 'Expected Moody chart compact log-log metadata styling');
assert(styles.includes('pipe-moody-chip-meta'), 'Expected compact Moody chart marker metadata styling');
